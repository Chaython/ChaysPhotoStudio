...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'magic-wand', label: 'Magic Wand', group: 1, shortcut: 'W', icon: 'Wand2', cursor: 'crosshair', defaults: { mode: 'new', tolerance: 32, contiguous: true, diagonal: false, sample: 'composite', antiAlias: true }, options: [selMode, { key: 'tolerance', label: 'Tolerance', type: 'slider', min: 0, max: 255, step: 1 }, { key: 'contiguous', label: 'Contiguous', type: 'toggle' }, { key: 'diagonal', label: 'Diagonal Fill', type: 'toggle', hint: '8-connected fill — includes diagonally adjacent pixels' }, { key: 'sample', label: 'Sample', type: 'select', options: [{ label: 'Composite', value: 'composite' }, { label: 'Active Layer', value: 'layer' }] }, antialiasCtl] },
  ...
  // group 5 — retouching
  { id: 'clone-stamp', label: 'Clone Stamp', group: 5, shortcut: 'S', icon: 'Stamp', cursor: 'none', requiresLayer: true, defaults: { size: 60, hardness: 70, opacity: 100, flow: 100, spacing: 15, aligned: true, mirrored: false, rotate: 0 }, options: [...brushCtls, { key: 'aligned', label: 'Aligned', type: 'toggle' }, { key: 'mirrored', label: 'Mirrored', type: 'toggle' }, { key: 'rotate', label: 'Rotate', type: 'angle' }] },
  { id: 'healing-brush', label: 'Healing Brush', group: 5, shortcut: 'J', icon: 'Bandage', cursor: 'none', requiresLayer: true, defaults: { size: 40, hardness: 60, opacity: 100, flow: 100, spacing: 15, aligned: true }, options: [...brushCtls, { key: 'aligned', label: 'Aligned', type: 'toggle' }] },
  ...
  { id: 'dodge', label: 'Dodge', group: 5, shortcut: 'O', icon: 'Sun', cursor: 'none', requiresLayer: true, defaults: { size: 60, hardness: 60, exposure: 30, range: 'midtones' }, options: [{ key: 'size', label: 'Size', type: 'slider', min: 4, max: 400, step: 1, unit: 'px' }, { key: 'hardness', label: 'Hardness', type: 'slider', min: 0, max: 100, step: 1, unit: '%' }, { key: 'exposure', label: 'Exposure', type: 'slider', min: 1, max: 100, step: 1, unit: '%' }, { key: 'range', label: 'Range', type: 'select', options: [{ label: 'Shadows', value: 'shadows' }, { label: 'Midtones', value: 'midtones' }, { label: 'Highlights', value: 'highlights' }] }] },
  ...
  { id: 'shape', label: 'Shape', group: 6, shortcut: 'U', icon: 'Shapes', cursor: 'crosshair', defaults: { shape: 'rect', radius: 12, fill: '#e8a33d', stroke: null, strokeWidth: 4 }, options: [{ key: 'shape', label: 'Shape', type: 'select', options: [{ label: 'Rectangle', value: 'rect' }, { label: 'Rounded Rect', value: 'rounded-rect' }, { label: 'Ellipse', value: 'ellipse' }, { label: 'Line', value: 'line' }] }, { key: 'fill', label: 'Fill', type: 'color' }, { key: 'stroke', label: 'Stroke', type: 'color' }, { key: 'strokeWidth', label: 'Stroke Width', type: 'slider', min: 1, max: 100, step: 1, unit: 'px' }, { key: 'radius', label: 'Corner Radius', type: 'slider', min: 0, max: 200, step: 1, unit: 'px' }] },
