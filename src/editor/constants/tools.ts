...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'patch', label: 'Patch', group: 5, shortcut: 'J', icon: 'Spline', cursor: 'crosshair', requiresLayer: true, defaults: { mode: 'new', heal: 'content-aware', diffusion: 5, sampleAllLayers: false }, options: [selMode, { key: 'heal', label: 'Patch', type: 'select', options: [{ label: 'Content-Aware', value: 'content-aware' }, { label: 'Texture Only', value: 'texture' }] }, { key: 'diffusion', label: 'Diffusion', type: 'slider', min: 1, max: 7, step: 1 }, { key: 'sampleAllLayers', label: 'Sample All Layers', type: 'toggle' }] },
