...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'measure', label: 'Measure', group: 3, shortcut: 'K', icon: 'Ruler', cursor: 'crosshair', defaults: { angleSnap: 45, showDelta: true, persist: true, unit: 'px', pixelsPerUnit: 1 }, options: [{ key: 'angleSnap', label: 'Shift Angle', type: 'select', options: [{ label: '15°', value: 15 }, { label: '30°', value: 30 }, { label: '45°', value: 45 }, { label: '90°', value: 90 }] }, { key: 'unit', label: 'Units', type: 'select', options: [{ label: 'Pixels', value: 'px' }, { label: 'Millimeters', value: 'mm' }, { label: 'Centimeters', value: 'cm' }, { label: 'Inches', value: 'in' }] }, { key: 'pixelsPerUnit', label: 'px / unit', type: 'number', min: 0.001, max: 100000, step: 0.01, hint: 'Calibration: how many document pixels equal one selected unit' }, { key: 'showDelta', label: 'Show ΔX / ΔY', type: 'toggle' }, { key: 'persist', label: 'Keep Measurement', type: 'toggle', hint: 'Keep the ruler visible after switching tools' }] },
  ...
  { id: 'smudge', label: 'Smudge', group: 5, shortcut: 'R', icon: 'Fingerprint', cursor: 'none', requiresLayer: true, defaults: { size: 50, hardness: 70, strength: 60, sampleAllLayers: false, fingerPainting: false, pressureStrength: true, pressureSize: false }, options: [{ key: 'size', label: 'Size', type: 'slider', min: 4, max: 300, step: 1, unit: 'px' }, { key: 'hardness', label: 'Hardness', type: 'slider', min: 0, max: 100, step: 1, unit: '%' }, { key: 'strength', label: 'Strength', type: 'slider', min: 1, max: 100, step: 1, unit: '%' }, { key: 'sampleAllLayers', label: 'Sample All Layers', type: 'toggle' }, { key: 'fingerPainting', label: 'Finger Painting', type: 'toggle' }, { key: 'pressureStrength', label: 'Pen Pressure → Strength', type: 'toggle' }, { key: 'pressureSize', label: 'Pen Pressure → Size', type: 'toggle' }] },
