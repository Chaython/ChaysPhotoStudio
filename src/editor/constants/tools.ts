...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'crop', label: 'Crop', group: 3, shortcut: 'C', icon: 'Crop', cursor: 'crosshair', defaults: { ratio: 'free', overlay: 'thirds', deletePixels: false }, options: [{ key: 'ratio', label: 'Ratio', type: 'select', options: [{ label: 'Free', value: 'free' }, { label: '1:1', value: '1:1' }, { label: '4:3', value: '4:3' }, { label: '3:2', value: '3:2' }, { label: '16:9', value: '16:9' }, { label: '9:16', value: '9:16' }] }, { key: 'overlay', label: 'Overlay', type: 'select', options: [{ label: 'Rule of Thirds', value: 'thirds' }, { label: 'Grid', value: 'grid' }, { label: 'Diagonal', value: 'diagonal' }, { label: 'Golden Ratio', value: 'golden' }, { label: 'None', value: 'none' }] }, { key: 'deletePixels', label: 'Delete Cropped Pixels', type: 'toggle', hint: 'Off preserves hidden raster pixels outside the new frame' }] },
  ...
  { id: 'measure', label: 'Measure', group: 3, shortcut: 'K', icon: 'Ruler', cursor: 'crosshair', defaults: { angleSnap: 45, showDelta: true }, options: [{ key: 'angleSnap', label: 'Shift Angle', type: 'select', options: [{ label: '15°', value: 15 }, { label: '30°', value: 30 }, { label: '45°', value: 45 }, { label: '90°', value: 90 }] }, { key: 'showDelta', label: 'Show ΔX / ΔY', type: 'toggle' }] },
