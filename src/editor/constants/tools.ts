...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'object-select', label: 'Object Selection', group: 1, shortcut: 'W', icon: 'ScanSearch', cursor: 'crosshair', defaults: { mode: 'new', feather: 1, level: 'balanced', sample: 'composite', antiAlias: true }, options: [selMode, { key: 'sample', label: 'Sample', type: 'select', options: [{ label: 'All Layers', value: 'composite' }, { label: 'Active Layer', value: 'layer' }] }, { key: 'level', label: 'AI Level', type: 'select', options: [{ label: 'Fast', value: 'fast' }, { label: 'Balanced', value: 'balanced' }, { label: 'Thorough', value: 'thorough' }] }, featherCtl, antialiasCtl]},
  ...
  { id: 'crop', label: 'Crop', group: 3, shortcut: 'C', icon: 'Crop', cursor: 'crosshair', defaults: { ratio: 'free', ratioW: 1, ratioH: 1, overlay: 'thirds', deletePixels: false }, options: [{ key: 'ratio', label: 'Ratio', type: 'select', options: [{ label: 'Free', value: 'free' }, { label: 'Custom', value: 'custom' }, { label: '1:1', value: '1:1' }, { label: '4:3', value: '4:3' }, { label: '3:2', value: '3:2' }, { label: '16:9', value: '16:9' }, { label: '9:16', value: '9:16' }] }, { key: 'ratioW', label: 'Ratio W', type: 'number', min: 0.01, max: 1000, step: 0.1 }, { key: 'ratioH', label: 'Ratio H', type: 'number', min: 0.01, max: 1000, step: 0.1 }, { key: 'overlay', label: 'Overlay', type: 'select', options: [{ label: 'Rule of Thirds', value: 'thirds' }, { label: 'Grid', value: 'grid' }, { label: 'Diagonal', value: 'diagonal' }, { label: 'Golden Ratio', value: 'golden' }, { label: 'None', value: 'none' }] }, { key: 'deletePixels', label: 'Delete Cropped Pixels', type: 'toggle', hint: 'Off preserves hidden raster pixels outside the new frame' }] },
  { id: 'eyedropper', label: 'Color Picker', group: 2, shortcut: 'I', icon: 'Pipette', cursor: 'crosshair', defaults: { sample: 'composite', radius: 1 }, options: [{ key: 'sample', label: 'Sample', type: 'select', options: [{ label: 'All Layers', value: 'composite' }, { label: 'Current Layer', value: 'layer' }] }, { key: 'radius', label: 'Sample Size', type: 'select', options: [{ label: 'Point Sample', value: 1 }, { label: '3 × 3 Average', value: 3 }, { label: '5 × 5 Average', value: 5 }, { label: '7 × 7 Average', value: 7 }, { label: '11 × 11 Average', value: 11 }] }] },
  { id: 'measure', label: 'Measure', group: 3, shortcut: 'K', icon: 'Ruler', cursor: 'crosshair', defaults: { angleSnap: 45, showDelta: true, persist: true }, options: [{ key: 'angleSnap', label: 'Shift Angle', type: 'select', options: [{ label: '15°', value: 15 }, { label: '30°', value: 30 }, { label: '45°', value: 45 }, { label: '90°', value: 90 }] }, { key: 'showDelta', label: 'Show ΔX / ΔY', type: 'toggle' }, { key: 'persist', label: 'Keep Measurement', type: 'toggle', hint: 'Keep the ruler visible after switching tools' }] },
  ...
  { id: 'eraser', label: 'Eraser', group: 4, shortcut: 'E', icon: 'Eraser', cursor: 'none', requiresLayer: true, defaults: { size: 40, hardness: 70, opacity: 100, flow: 100, spacing: 15, tip: 'round-soft', angle: 0, angleFollow: false, roundness: 100, symmetry: 'off', mandalaCount: 6, mode: 'brush', pressure: true }, options: [{ key: 'mode', label: 'Mode', type: 'select', options: [{ label: 'Brush', value: 'brush' }, { label: 'Pencil', value: 'pencil' }, { label: 'Block', value: 'block' }] }, ...brushCtls, { key: 'pressure', label: 'Pen Pressure', type: 'toggle' }, { key: 'tip', label: 'Tip', type: 'select', options: eraserTipSelectOptions }, { key: 'angle', label: 'Angle', type: 'angle', min: 0, max: 360, step: 1, unit: '°', hint: 'Tip rotation (rotatable tips)' }, { key: 'roundness', label: 'Roundness', type: 'slider', min: 10, max: 100, step: 1, unit: '%', hint: 'Calligraphy nib squash' }, { key: 'angleFollow', label: 'Follow', type: 'toggle', hint: 'Rotate the tip with the stroke direction' }, symmetryCtl, mandalaCtl] },

  // group 5 — retouching
  { id: 'clone-stamp', label: 'Clone Stamp', group: 5, shortcut: 'S', icon: 'Stamp', cursor: 'none', requiresLayer: true, defaults: { size: 60, hardness: 70, opacity: 100, flow: 100, spacing: 15, blendMode: 'normal', aligned: true, mirrored: false, rotate: 0, scale: 100, sample: 'layer' }, options: [...brushCtls, { key: 'blendMode', label: 'Mode', type: 'select', options: paintBlendOptions }, { key: 'sample', label: 'Sample', type: 'select', options: [{ label: 'Current Layer', value: 'layer' }, { label: 'Current & Below / Composite', value: 'composite' }] }, { key: 'aligned', label: 'Aligned', type: 'toggle' }, { key: 'mirrored', label: 'Mirrored', type: 'toggle' }, { key: 'rotate', label: 'Rotate', type: 'angle' }, { key: 'scale', label: 'Source Scale', type: 'slider', min: 25, max: 400, step: 1, unit: '%' }] },
  { id: 'healing-brush', label: 'Healing Brush', group: 5, shortcut: 'J', icon: 'Bandage', cursor: 'none', requiresLayer: true, defaults: { size: 40, hardness: 60, opacity: 100, flow: 100, spacing: 15, blendMode: 'normal', aligned: true, sample: 'layer', diffusion: 5, pressure: true, mirrored: false, rotate: 0, scale: 100 }, options: [...brushCtls, { key: 'blendMode', label: 'Mode', type: 'select', options: paintBlendOptions }, { key: 'sample', label: 'Sample', type: 'select', options: [{ label: 'Current Layer', value: 'layer' }, { label: 'All Layers', value: 'composite' }] }, { key: 'aligned', label: 'Aligned', type: 'toggle' }, { key: 'diffusion', label: 'Diffusion', type: 'slider', min: 1, max: 7, step: 1 }, { key: 'pressure', label: 'Pen Pressure', type: 'toggle' }, { key: 'mirrored', label: 'Mirrored', type: 'toggle' }, { key: 'rotate', label: 'Source Rotate', type: 'angle' }, { key: 'scale', label: 'Source Scale', type: 'slider', min: 25, max: 400, step: 1, unit: '%' }] },
  { id: 'spot-healing', label: 'Spot Healing', group: 5, shortcut: 'J', icon: 'Sparkles', cursor: 'none', requiresLayer: true, defaults: { size: 40, hardness: 60, type: 'content-aware', sampleAllLayers: false }, options: [{ key: 'size', label: 'Size', type: 'slider', min: 4, max: 300, step: 1, unit: 'px' }, { key: 'hardness', label: 'Hardness', type: 'slider', min: 0, max: 100, step: 1, unit: '%' }, { key: 'type', label: 'Mode', type: 'select', options: [{ label: 'Content-Aware', value: 'content-aware' }, { label: 'Proximity Match', value: 'proximity' }] }, { key: 'sampleAllLayers', label: 'Sample All Layers', type: 'toggle' }] },
  { id: 'patch', label: 'Patch', group: 5, shortcut: 'J', icon: 'Spline', cursor: 'crosshair', requiresLayer: true, defaults: { mode: 'new', heal: 'content-aware', diffusion: 5 }, options: [selMode, { key: 'heal', label: 'Patch', type: 'select', options: [{ label: 'Content-Aware', value: 'content-aware' }, { label: 'Texture Only', value: 'texture' }] }, { key: 'diffusion', label: 'Diffusion', type: 'slider', min: 1, max: 7, step: 1 }] },
  { id: 'blur', label: 'Blur', group: 5, shortcut: 'R', icon: 'Droplets', cursor: 'none', requiresLayer: true, defaults: { size: 60, hardness: 60, strength: 60, pressure: true }, options: [{ key: 'size', label: 'Size', type: 'slider', min: 4, max: 400, step: 1, unit: 'px' }, { key: 'hardness', label: 'Hardness', type: 'slider', min: 0, max: 100, step: 1, unit: '%' }, { key: 'strength', label: 'Strength', type: 'slider', min: 1, max: 100, step: 1, unit: '%' }, { key: 'pressure', label: 'Pen Pressure', type: 'toggle' }] },
  { id: 'sharpen', label: 'Sharpen', group: 5, shortcut: 'R', icon: 'Zap', cursor: 'none', requiresLayer: true, defaults: { size: 60, hardness: 60, strength: 50, threshold: 2, pressure: true }, options: [{ key: 'size', label: 'Size', type: 'slider', min: 4, max: 400, step: 1, unit: 'px' }, { key: 'hardness', label: 'Hardness', type: 'slider', min: 0, max: 100, step: 1, unit: '%' }, { key: 'strength', label: 'Strength', type: 'slider', min: 1, max: 100, step: 1, unit: '%' }, { key: 'threshold', label: 'Threshold', type: 'slider', min: 0, max: 50, step: 1 }, { key: 'pressure', label: 'Pen Pressure', type: 'toggle' }] },
  { id: 'smudge', label: 'Smudge', group: 5, shortcut: 'R', icon: 'Fingerprint', cursor: 'none', requiresLayer: true, defaults: { size: 50, hardness: 70, strength: 60, sampleAllLayers: false, fingerPainting: false }, options: [{ key: 'size', label: 'Size', type: 'slider', min: 4, max: 300, step: 1, unit: 'px' }, { key: 'hardness', label: 'Hardness', type: 'slider', min: 0, max: 100, step: 1, unit: '%' }, { key: 'strength', label: 'Strength', type: 'slider', min: 1, max: 100, step: 1, unit: '%' }, { key: 'sampleAllLayers', label: 'Sample All Layers', type: 'toggle' }, { key: 'fingerPainting', label: 'Finger Painting', type: 'toggle' }] },
