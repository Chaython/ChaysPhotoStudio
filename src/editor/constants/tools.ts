...
export const TOOL_DEFS: ToolDef[] = [
  ...
  { id: 'patch', label: 'Patch', group: 5, shortcut: 'J', icon: 'Spline', cursor: 'crosshair', requiresLayer: true, defaults: { mode: 'new', direction: 'source', heal: 'content-aware', diffusion: 5, sampleAllLayers: false }, options: [selMode, { key: 'direction', label: 'Patch Mode', type: 'select', options: [{ label: 'Source', value: 'source' }, { label: 'Destination', value: 'destination' }], hint: 'Source: select damage and drag to good pixels · Destination: select good pixels and drag them over damage' }, { key: 'heal', label: 'Patch', type: 'select', options: [{ label: 'Content-Aware', value: 'content-aware' }, { label: 'Texture Only', value: 'texture' }] }, { key: 'diffusion', label: 'Diffusion', type: 'slider', min: 1, max: 7, step: 1 }, { key: 'sampleAllLayers', label: 'Sample All Layers', type: 'toggle' }] },  { id: 'content-aware-move', label: 'Content-Aware Move', group: 5, shortcut: 'J', icon: 'Move3d', cursor: 'crosshair', requiresLayer: true, defaults: { mode: 'move', structure: 5, color: 5, sampleAllLayers: false }, options: [
