  ...
  return (
    <div className="p-2 flex flex-col gap-2 text-xs" aria-label="Clone Source panel">
      ...
      <div className="text-[10px] leading-relaxed text-muted-foreground">
        Scale, rotation, flip and overlay settings are remembered independently for each source slot. Export Sources embeds source snapshots and transforms in a portable preset. Imported sources reset destination alignment anchors for safety.
      </div>
    </div>
  )
}
