...
| Magic Eraser | One-click perceptual removal, tolerance, opacity, contiguous/global matching, anti-aliasing, active/all-layer sampling, sample averaging, edge protection, pixel-exact mode, selection-aware output | Edge decontamination and optional erase-to-new-mask workflow |
