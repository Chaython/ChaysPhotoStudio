...
| History Brush | Paint from previous or original history-state raster pixels, size/hardness/opacity/flow/spacing, pressure flow/size, selection-aware stroke commit | Arbitrary History-panel source marker and snapshot source selection |
| Art History Brush | Previous/original history source, Tight/Loose/Curl painterly styles, Area/Tolerance, opacity/flow/spacing, pressure flow/size | Additional stroke styles and deterministic seed controls |
